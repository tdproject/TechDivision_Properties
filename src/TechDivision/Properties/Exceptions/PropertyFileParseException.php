...
/**
 * This is the exception that is thrown if an error
 * occurs while parsing the specified file.
 *
 * @package TechDivision_Properties
 ...
 * @license GPL
 */
class TechDivision_Properties_Exceptions_PropertyFileParseException
    extends Exception {
}