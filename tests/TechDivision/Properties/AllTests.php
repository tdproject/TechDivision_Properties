...
require_once 'TechDivision/Properties/PropertiesTest.php';
 ...
 * @license GPL
 */
class TechDivision_Properties_AllTests
{
    ...
    public static function suite()
    {
        ...
        // add a test
        $suite->addTestSuite('TechDivision_Properties_PropertiesTest');
